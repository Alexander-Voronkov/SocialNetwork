...
{
    public partial class InitAppDbContextMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerId = table.Column<int>(type: "int", nullable: false),
                    ReferringCommentId = table.Column<int>(type: "int", nullable: true),
                    CommentBody = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ReferringCommentId1 = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Comments_ReferringCommentId",
                        column: x => x.ReferringCommentId,
                        principalTable: "Comments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Comments_Comments_ReferringCommentId1",
                        column: x => x.ReferringCommentId1,
                        principalTable: "Comments",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_ReferringCommentId",
                table: "Comments",
                column: "ReferringCommentId");

            migrationBuilder.CreateIndex(
                name: "IX_Comments_ReferringCommentId1",
                table: "Comments",
                column: "ReferringCommentId1");
